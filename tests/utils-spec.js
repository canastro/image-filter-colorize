...
describe('utils', function () {
    ...
    it('should convert a color from hex to rgb from a hex with hash', function () {
        var expectedResult = {
            r: 255,
            g: 0,
            b: 255
        };
        var result = utils.hexToRGB('#ff00ff');

        expect(result).to.deep.equal(expectedResult);
    });

    it('should convert a color from hex to rgb from a hex without hash', function () {
        var expectedResult = {
            r: 255,
            g: 0,
            b: 255

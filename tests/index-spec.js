...
var imageFilterColorize = require('../src/index');
...
describe('index', function () {
   ...
   afterEach(function () {
    ...
    it('should apply colorize transformation and return as imageData', function () {
        var imageData = {
            data: [193, 219, 242, 255]
        };

        const expectedData = {
            data: [224, 109.5, 248.5, 255]
        };
    ...
    it('should apply colorize transformation and return as dataURL', function() {
        var imageData = {
            data: [193, 219, 242, 255]
        };
